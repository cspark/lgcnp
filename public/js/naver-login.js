 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<button onclick=location.href='"+naver_id_login_url+"' id='naver_id_login_anchor' class='col-md-4 btn btn-custom-1' style='background-color: #1EC800; color:white; margin-top:5px;'>Login with Naver</button>";
      // naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'>test</a> ";
		}
