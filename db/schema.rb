...
ActiveRecord::Schema.define(version: 20180212062628) do
  ...
  create_table "admin_users", force: :cascade do |t|
    ...
    t.string   "last_change_password_at"
    t.string   "access_ip"
  ...
  create_table "tb_survey_answers", force: :cascade do |t|
  ...
  create_table "tb_survey_questions", force: :cascade do |t|
  ...
  create_table "tbsurveys", force: :cascade do |t|
