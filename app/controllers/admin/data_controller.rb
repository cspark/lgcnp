class Admin::DataController < Admin::AdminApplicationController
  ...
  def list
    ...
    if @select_filter == []
      @excel_name = ["시리얼","이름","분석 횟수","채널","측정 부위","진단 날짜","업데이트 일","수분 측정 우측 볼","수분 측정 좌측 볼","수분 측정 이마","모공 측정 이마","모공 측정 코","모공 측정 우측 볼","모공 측정 좌측 볼","모공 측정 평균","주름 측정 우측 눈옆", "주름 측정 우측 눈밑", "주름 측정 좌측 눈옆",
      ...
      @excel_name = ["시리얼","이름","분석 횟수","채널구분","측정 부위","진단 날짜","업데이트 일"]
  ...
  def beau_list
    ...
    if @select_filter == []
      @excel_name = ["시리얼","이름","분석 횟수","채널구분","측정 부위","진단 날짜","업데이트 일","수분 측정 우측 볼","수분 측정 좌측 볼","수분 측정 이마","모공 측정 이마","모공 측정 코","모공 측정 우측 볼","모공 측정 좌측 볼","모공 측정 평균","주름 측정 우측 눈옆", "주름 측정 우측 눈밑", "주름 측정 좌측 눈옆","주름 측정 좌측 눈밑", "주름 측정 평균",
      "탄력 측정 우측 볼", "탄력 측정 좌측 볼", "탄력 측정 평균", "탄력 각도 우측 볼", "탄력 각도 좌측 볼", "피지 개수 이마", "피지 개수 코", "피지 개수 우측 볼", "피지 개수 좌측 볼", "피지 개수 평균", "포피린 개수 이마", "포피린 개수 코", "포피린 개수 우측 볼", "포피린 개수 좌측 볼", "포피린 개수 평균",
