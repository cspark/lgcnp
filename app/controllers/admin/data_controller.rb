class Admin::DataController < Admin::AdminApplicationController
  ...
  def list
    ...
    # @select_skin_type_device = select_skin_type_device if !select_skin_type_device.blank?
    # @select_skin_type_survey = select_skin_type_survey if !select_skin_type_survey.blank?
