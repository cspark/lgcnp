class Admin::PosController < Admin::AdminApplicationController
  ...
  def list
    ...
    if @select_filter == []
      @excel_name = ["이름","채널구분","측정 부위","진단 날짜","분석 횟수","업데이트 일","이마 영역정보x","이마 영역정보y","이마 영역정보w","이마 영역정보h","코 영역정보x","코 영역정보y","코 영역정보w","코 영역정보h",
      ...
      @excel_name = ["이름","채널구분","측정 부위","진단 날짜","분석 횟수","업데이트 일"]
