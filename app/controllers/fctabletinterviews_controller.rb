class FctabletinterviewsController < ApplicationController
  ...
  def permitted_param
    ...
    :before_made_cosmetic,:after_made_cosmetic,:ch_cd, :base_lot, :ampoule_1_lot, :ampoule_2_lot, :is_quick_mode, :mixer_name, :is_agree_privacy, :is_agree_thirdparty_info, :is_agree_marketing, :fcdata_id)
  end
end
