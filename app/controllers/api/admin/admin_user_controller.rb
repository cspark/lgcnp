    ...
    if user_list.count > 0
      if user_list.count > 0 && Rails.env.production? || Rails.env.staging?
        ...
        fcdata_list.each do |fcdata|
          ...
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_Sym_L_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_Sym_L_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_Sym_R_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_Sym_R_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_Sym_R_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_Sym_R_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_UV_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_UV_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_UV_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_UV_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_WH_PWC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_WH_PWC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_WH_PWC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_WH_PWC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_WH_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_WH_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_WH_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_WH_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_UVGR_SBC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_UVGR_SBC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_UVGR_SBC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_UVGR_SBC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_UV_GR_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_UV_GR_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_UV_GR_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_UV_GR_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_PL_PLC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_PL_PLC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_PL_PLC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_PL_PLC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_UVGR_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_UVGR_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_UVGR_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_UVGR_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_PL_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_PL_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_PL_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_PL_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "1", type: "_F_FM_PL_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "2", type: "_F_FM_PL_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "3", type: "_F_FM_PL_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: "4", type: "_F_FM_PL_UVC_",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: nil, type: "_F_FM_WH_PWC_W",  ch_cd: fcdata.ch_cd)
          image_remove(serial: fcdata.custserial.to_i, measureno: fcdata.measureno.to_s, number: nil, type: "_F_FM_WH_E",  ch_cd: fcdata.ch_cd)
