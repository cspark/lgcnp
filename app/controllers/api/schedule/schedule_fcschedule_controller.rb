class Api::Schedule::ScheduleFcscheduleController < Api::ApplicationController
  def index
    ...
    list = Fcschedule.where(ch_cd: params[:ch_cd], shop_cd: params[:shop_cd], reserve_yyyy: params[:reserve_yyyy], reserve_mmdd: params[:reserve_mmdd], reserve_hhmm: params[:reserve_hhmm])
    if list.count > 0
