class Api::Tablet::Cnprx::FctabletinterviewrxesController < Api::ApplicationController
  ...
  def permitted_param
    ...
    :recommand_program_step_1, :recommand_program_step_2, :recommand_program_step_3, :purchase1, :purchase2, :purchase3, :base_lot, :ampoule_1_lot, :ampoule_2_lot, :mixer_name, :memo, :before_overlap, :after_overlap, :recommand_bb, :recommand_sun, :recommand_program1, :recommand_program2)
  end
end
