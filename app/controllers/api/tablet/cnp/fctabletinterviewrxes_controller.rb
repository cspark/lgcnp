class Api::Tablet::Cnp::FctabletinterviewrxesController < Api::ApplicationController
  ...
  def permitted_param
    ...
    :before_overlap, :after_overlap, :recommand_bb, :recommand_sun, :recommand_program1, :recommand_program2,
    :before_solution_1_new, :before_solution_2_new)
  end
end
