class FcgeneInterview < ApplicationRecord
  ...
  belongs_to :fcdata, -> (fcgene_interview) { unscope(:where).where("custserial = :custserial AND measureno = :measureno", custserial: fcgene_interview.custseiral, measureno: fcgene_interview.measureno) }, class_name: 'Fcdata'
